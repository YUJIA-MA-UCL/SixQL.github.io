...
In addition, we compared our outcome to UNOSAT Ground truth datasets to validate the model's performance to detect damaged buildings by spatially interactive matching. *(UNOSAT, cited in Dietrich et al., 2025)*
\
##### **Results**
\
